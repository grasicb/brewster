...
#define HSPI_SET_CLOCK() if (BrewsterGlobals::get()->global_spi_clock != SPI_CLOCK_DIV2) {BrewsterGlobals::get()->global_spi_clock = SPI_CLOCK_DIV2; SPI_OBJECT.setClockDivider(SPI_CLOCK_DIV2);}
